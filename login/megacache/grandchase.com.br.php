...
*
* Plugin Grand Chase
* Cache flash video files from uol.com.br
* Need to put "fpatch.grandchase.com.br" in squid.conf in line "acl store_rewrite_list dstdomain"
*
...
if (preg_match("/^http:\/\/fpatch\.grandchase\.com\.br.*/", $url, $result)) {
	$file = explode("/",$url);
	$file = $file[count($file)-1];
	if (strrpos($file,".kom") !== false) {
