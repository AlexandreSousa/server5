...
if ((isset($_GET['id'])) && ($_GET['id'] != "")) {
  $deleteSQL = sprintf("DELETE FROM radios WHERE id=%s",
...
$colname_qr_radio = "-1";
if (isset($_GET['id'])) {
  $colname_qr_radio = $_GET['id'];
}
mysql_select_db($database_Conexao, $Conexao);
$query_qr_radio = sprintf("SELECT * FROM radios WHERE id = %s", GetSQLValueString($colname_qr_radio, "int"));
