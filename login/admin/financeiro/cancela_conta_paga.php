...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  $Result1 = mysql_query($updateSQL, $Conexao) or die(mysql_error());
    echo "CONTA CANCELADA COM SUCESSO";
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table width="100%" border="0" align="center">
    <tr>
      <td background="../../imagens/capa_fundo.png"><span class="style1">CANCELAR CONTA A PAGAR</span></td>
    </tr>
  </table>
  <table width="100%" align="center" id="tabela2">
    ...
    <tr valign="baseline">
      ...
      <td class="imputTxt"><input name="obs" type="text" class="imputTxt" value="<?php echo htmlentities($row_qr_paga['obs'], ENT_COMPAT, 'utf-8'); ?>" size="32" />
<label></label></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td class="imputTxt"><input type="hidden" name="status" value="cancelado" size="32" />
    ...
    <tr valign="baseline">
      ...
      <td><input type="submit" class="BnT" value="Cancela" /></td>
    </tr>
  </table>
