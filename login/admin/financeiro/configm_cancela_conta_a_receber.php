...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  echo "<meta http-equiv='refresh' content='2;URL=?pg=financeiro/cancela_conta_a_receber'>";
}
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table width="100%" align="center" id="tabela2">
    ...
    <tr valign="baseline">
      ...
      <td><input type="hidden" name="status" value="cancelado" size="32" />
    ...
    <tr valign="baseline">
      ...
      <td><input name="data_recebido" type="text" class="imputTxt" value="<?php echo ("$ano-$mes-$dia"); ; ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">&nbsp;</td>
      <td><input type="submit" class="BnT" id="form1" value="Cancela Fatura" /></td>
    </tr>
  </table>
