...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE usuarios SET id_cliente=%s, mac=%s, id_esec=%s, id_auth=%s, situacao=%s, a_ip=%s, ip=%s, login=%s, senha=%s, proxy=%s, banda=%s, site=%s, id_tempo=%s, id_volume=%s, cliente_f=%s WHERE id=%s",
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table width="100%" align="center">
    ...
    <tr valign="baseline">
      <td width="19%" rowspan="16" align="center" valign="top" nowrap="nowrap"><table width="200" border="0">
        <tr>
      ...
      <td width="34%" rowspan="16"><table width="38" border="0">
        <tr>
...
?>
    ...
    <tr valign="baseline">
      <td colspan="2" align="center" nowrap="nowrap" background="../imagens/message_toolbar_tile.gif"><strong>Controle de Volume e Tempo</strong></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Controle de Tempo:</td>
      <td><select name="id_tempo" id="id_tempo">
        <option value="0" <?php if (!(strcmp(0, $row_edit_login['id_tempo']))) {echo "selected=\"selected\"";} ?>>Selecione</option>
        <?php
do {  
?>
        <option value="<?php echo $row_qr_tempo['id']?>"<?php if (!(strcmp($row_qr_tempo['id'], $row_edit_login['id_tempo']))) {echo "selected=\"selected\"";} ?>><?php echo $row_qr_tempo['desc']?></option>
        <?php
...
?>
    ...
    <tr valign="baseline">
      ...
      <td><select name="id_volume" id="id_volume">
        <option value="0" <?php if (!(strcmp(0, $row_edit_login['id_volume']))) {echo "selected=\"selected\"";} ?>>Selecione</option>
        <?php
do {  
?>
        <option value="<?php echo $row_qr_volume['id']?>"<?php if (!(strcmp($row_qr_volume['id'], $row_edit_login['id_volume']))) {echo "selected=\"selected\"";} ?>><?php echo $row_qr_volume['tipo']?></option>
        <?php
...
?>
    ...
    <tr valign="baseline">
      ...
      <td colspan="2" align="center" nowrap="nowrap" background="../imagens/message_toolbar_tile.gif"><strong>Financeiro</strong></td>
      <td>&nbsp;</td>
    </tr>
    <tr valign="baseline">
      <td align="center" valign="top" nowrap="nowrap">&nbsp;</td>
      <td nowrap="nowrap" align="right">Sistema de Cobrança:</td>
      <td><select name="cliente_f" id="cliente_f">
        <option value="Cobra" <?php if (!(strcmp("Cobra", $row_edit_login['cliente_f']))) {echo "selected=\"selected\"";} ?>>cobra</option>
        <option value="Bloquear" <?php if (!(strcmp("Bloquear", $row_edit_login['cliente_f']))) {echo "selected=\"selected\"";} ?>>bloquear</option>
                  </select></td>
      <td>&nbsp;</td>
    </tr>
  </table>
