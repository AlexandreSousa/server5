...
$query_qr_sessao = "SELECT * FROM sessao WHERE data BETWEEN '$datainicial' AND '$datafinal'";
...
<?php
	...
	$comando = "SELECT * FROM sessao WHERE data BETWEEN '$datainicial' AND '$datafinal'";
	...
	$chart->setTitle("Gerado por www.uniaomaker.com.br |||| Inicio $datainicial a $datafinal");
	$chart->render("../libchart/demo/generated/demo$datainicial.png");
?>
<div id="CollapsiblePanel1" class="CollapsiblePanel">
  <div class="CollapsiblePanelTab" tabindex="0"><img src="../imagens/grafico.png" width="22" height="22" border="0" align="absmiddle" />Download</div>
...
include "../libchart/libchart/classes/libchart.php";
	...
	$dataSet->addPoint(new Point("$data", $up));
...
$sql2 = mysql_query ("SELECT sum(down) as down FROM sessao WHERE data BETWEEN '$datainicial' AND '$datafinal'"); 
...
$sql = mysql_query ("SELECT sum(up) as up FROM sessao WHERE data BETWEEN '$datainicial' AND '$datafinal'"); 
$linhas = mysql_num_rows($sql);
